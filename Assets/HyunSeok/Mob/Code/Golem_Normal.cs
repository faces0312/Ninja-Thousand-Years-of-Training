...
public class Golem_Normal : MonoBehaviour
{
    public Animator die;
    public Golem_Normal_Body golem_Normal_Body;
    ...
    private void OnEnable()
    {
        ...
        speed = 0.9f;
        //target_on = false;
        golem_Normal_Body.gameObject.SetActive(true);
    ...
    public void Die()
    {
        ...
        golem_Normal_Body.StopAllCoroutines();
