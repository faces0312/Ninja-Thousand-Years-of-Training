...
public class Golem_Mecha_Body : MonoBehaviour
{
    public Golem_Mecha mob;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.tag == "WindWall")    //건들
        {
            ...
            if (Data.Instance.gameData.windwall_lv == 1)
                mob.hp -= ((2 + Data.Instance.gameData.player_wood) * 1.3f);
            else if (Data.Instance.gameData.windwall_lv == 2)
                mob.hp -= ((4 + Data.Instance.gameData.player_wood) * 1.3f);
            else if (Data.Instance.gameData.windwall_lv == 3)
                mob.hp -= ((6 + Data.Instance.gameData.player_wood) * 1.3f);
