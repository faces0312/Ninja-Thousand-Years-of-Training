...
public class ObjectManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (boss_Tmp_CT > 0)
        {
            if (boss_Tmp_CT < 2.5f)
            {
                manager.warning.gameObject.SetActive(true);
            }
    ...
    IEnumerator Golem_Boss_Lighting(Vector3 vector3)
    {
        ...
        manager.sound.bossLightning.Stop();
    }
